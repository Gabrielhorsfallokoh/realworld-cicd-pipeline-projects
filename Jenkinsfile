...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                -Dsonar.host.url=http://172.31.57.49:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#cicd-pipeline-project-tesonglobalinc', //update and provide your channel name
